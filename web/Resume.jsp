    ...
    <body>
         <nav class="navbar navbar-inverse navbar-fixed-top">
             <div class="container">
                ...
                <div id="navbar" class="navbar-collapse collapse in" aria-expanded="false" align='right'>
                        ...
                        <div class="col-md-6" align="center">
                            ...
                            <div id="employment">
                                ...
                                <div id="employment2">
                                    ...
                                    <div>
                                        <p>Worked as a Press Operator gained knowledge of spot welding, assembly processes, and 
                                        quality assurance.
                                        </p>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-3 col-md-offset-1">
                                <div id="edu">
                                    <h2>Education</h2>
                                    <h3>2013-Present
                                    Attending Waukesha County Technical College
                                    </h3>
                                    <div id="programming">
                                    <h4>Programming</h4>
                                        <ul>
